...
//	+"/searchAdmins"
	return {
		...
		deleteAdmin:baseUrl + "/adminService/deleteAdmin/", // proper ulr reqd
		...
		deletePartner: baseUrl + "/partnerService/deletePartner/",
		...
		searchPartner: baseUrl + "/partnerService/searchPartners/"
	};
})());